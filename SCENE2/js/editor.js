...
function renderForm() {
    form.innerHTML = `
        ...
        <div class="form-group">
            ...
            <textarea oninput="updateQuizTopText(this.value)">${(gameConfig.quizScene.topText && gameConfig.quizScene.topText.text) ? gameConfig.quizScene.topText.text : (gameConfig.quizScene.text || '')}</textarea>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label>문제 내용</label>
            <textarea oninput="updateNested('quizScene', 'problem', this.value)">${gameConfig.quizScene.problem}</textarea>
        </div>
        <div class="form-group">
        ...
        <div id="items-list">
            ${gameConfig.listScene.items.map((item, index) => `
                <div class="item-row">
                    ...
                    <div class="form-group">
                        <label>설명 텍스트</label>
                        <textarea oninput="updateItem(${index}, 'text', this.value)">${item.text}</textarea>
                    </div>
                </div>
            `).join('')}
        </div>
